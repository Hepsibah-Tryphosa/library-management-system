...
describe('CollegeInfo routing resolve service', () => {
  ...
  let resultCollegeInfo: ICollegeInfo | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultCollegeInfo).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ICollegeInfo>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
